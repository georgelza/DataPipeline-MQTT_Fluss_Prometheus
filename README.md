...
2.  Once on the Kafka Topics we will consume the payloads using a MQTT/Flink connector into `hive_catalog.mqtt.factory_iot_#` tables. This is done using `<root>/devlab0/creFlinkFlows/2.1.creMQTTSource.sql`
